...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.previewPadding = 2; // (px) space between color preview and content of the previewElement
		this.required = true; // whether the associated text input must always contain a color value. If false, the input can be left empty.
		this.hash = true; // whether to prefix the HEX color code with # symbol (only applicable for HEX format)
		this.uppercase = false; // whether to show the HEX color code in upper case (only applicable for HEX format)
		...
		this.padding = 12; // px
		this.backgroundColor = 'rgba(0,0,0,0.2)'; // CSS color
